...
async def backfill_auto_router_benchmarks(
    start_date: str,
    end_date: str,
    user_api_key_dict: Annotated[UserAPIKeyAuth, Depends(user_api_key_auth)],
):
    """Replay historical spend logs into the auto-router session rollup.
    ...
    return await backfill_sessions(prisma_client, llm_router, group_kinds, start_date, end_date)
